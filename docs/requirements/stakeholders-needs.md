...
2. Сервіс отримує запит від користувача 
3. Сервіс отримує всю потрібну інформацію 
4. Сервіс будує графіки на основі отриманої інформації 
5. Сервіс надає інформацію та побудовані графіки користувачу
6. Користувач отримує цікавившу його інформацію  
...
4. Працівник СП отримує тікет з питанням.  
5. Працівник СП дає відповідь на поставлене питання або вирішує проблему
6. Користувач отримує відповідь на своє питання.  
7. Працівник СП закриває тікет.  
